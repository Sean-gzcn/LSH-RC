...
public class LSHMRIloss extends ExperimentStatistics {

	String path;
	
	public LSHMRIloss(String path) {
		super(10, 10);
		...
		try{
			for(int i = 0; i<numOfVariables; i++){
				...
				for(int j = 0; j<numOfRounds; j++){
					String fileStr = path+"cluster-iloss-"+j+"-"+i;
	...
	public static void main(String[] args) {
		...
		//LSHMRIloss iloss4 = new LSHMRIloss("rlt/LSH-exp4/exp4/");
		//iloss4.dataReading();
		//iloss4.displaystatistics();
		
		System.out.println();
		LSHMRIloss iloss5 = new LSHMRIloss("rlt/LSH-exp5/exp5/output/");
		iloss5.dataReading();
		iloss5.displaystatistics();
